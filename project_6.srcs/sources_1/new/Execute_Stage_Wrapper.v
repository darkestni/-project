module Execute_Stage_Wrapper (
    ...
    assign rs2_value = forwardB_from_idex == 2'b01 ? exmem_alu_result :
                      forwardB_from_idex == 2'b10 ? memwb_write_to_reg :
    ...
    always @(*) begin
        ...
        case (forwardA_from_idex)
            2'b01: alu_operand_a = exmem_alu_result; // 来自EX/MEM
            2'b10: alu_operand_a = memwb_write_to_reg; // 来自MEM/WB
